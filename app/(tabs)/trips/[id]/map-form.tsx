...
const styles = StyleSheet.create({
  ...
  memberOffRoute: { backgroundColor: "#fef2f2", borderWidth: 1, borderColor: "#fecaca" },
  memberAvatar: {
    width: 38,
    height: 38,
    borderRadius: 19,
  ...
  mode: { flex: 1, minHeight: 44, borderRadius: 12, backgroundColor: "#f1f5f9", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 },
  ...
  recordActive: { borderColor: COLORS.primary, backgroundColor: "#eff6ff" },
  recordText: { flex: 1 },
