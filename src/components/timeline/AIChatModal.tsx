...
const createStyles = (palette: AppPalette) => StyleSheet.create({
  ...
  suggestion: { paddingHorizontal: 12, paddingVertical: 8, backgroundColor: palette.surface, borderRadius: 10, borderWidth: 1, borderColor: palette.border },
  ...
  preview: { backgroundColor: palette.successLight, borderWidth: 1, borderColor: palette.isDark ? "#2F6555" : "#BFE2D4", borderRadius: 12, padding: 14 },
  ...
  previewItem: { paddingVertical: 10, borderTopWidth: 1, borderTopColor: palette.isDark ? "#2F6555" : "#BFE2D4" },
